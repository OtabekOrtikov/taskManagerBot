...
async def get_debt_creation(callback: types.CallbackQuery, state: FSMContext):
    ...
    text = {
        "ru": "❗Вы хотите взять от кого-то долг. Пожалуйста, напишите ФИО и номер пользователя в формате \"ФИО - +998XXXXXXXXX\"",
        "oz": "❗Сиз кимдан қарз олишни хоҳлайсиз. Илтимос, ФИО ва фойдаланувчи рақамини \"ФИО - +998XXXXXXXXX\" форматида ёзинг",
        "uz": "❗Siz kimdan qarz olmoqchisiz. Iltimos, FIO va foydalanuvchi raqamini \"FIO - +998XXXXXXXXX\" formatida yozing"
    }
    ...
    await state.set_state(GetDebtCreation.getdebt_creditor)